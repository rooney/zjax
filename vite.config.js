...
const isCoverageTesting = process.env.VITE_COVERAGE
...
export default defineConfig({
  build: {
    lib: {
      ...
      fileName: () => isCoverageTesting ? 'zjax.coverage.js' : 'zjax.min.js', // Output file name
    ...
    minify: !isCoverageTesting,
    sourcemap: isCoverageTesting && 'inline',
    emptyOutDir: !isCoverageTesting,
  },
  plugins: [
    {
      name: "test-404",
